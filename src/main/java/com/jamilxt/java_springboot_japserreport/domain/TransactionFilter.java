...
public class TransactionFilter {
  ...
  public DynamicReportProperties generateDynamicColumnAndRows(List<Transaction> list) {
    ...
    columnHeaders.add("volume (LTR)");
    columnHeaders.add("Amount (TK)");
    columnHeaders.add("Unit Price (TK)");
    ...
    indexesOfColumnTypeNumber.add(columnHeaders.size() - 3); // "Total"
    indexesOfColumnTypeNumber.add(columnHeaders.size() - 2); // totalVolume
